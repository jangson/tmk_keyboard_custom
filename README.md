...
# Wireless GH60 satan Keyboard derived TMK Keyboard Firmware Collection
...
Build
-------
 * clone git clone https://github.com/jangson/tmk_keyboard_custom.git -b gh60-satan-wireless
 * git submodule init
 * git submodule update
 * cd keyboard/gh60
 * make
 * Refer USB receiver part to https://github.com/jangson/crazyradio-firmware.git
